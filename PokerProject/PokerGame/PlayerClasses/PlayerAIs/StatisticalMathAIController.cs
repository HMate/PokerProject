...
{
    class StatisticalMathAIController : AbstractAIController
    {
        ...
        static StatisticalMathAIController()
        {
        ...
        public StatisticalMathAIController()
        {
        ...
        private WinsTiesLosses DetermineWinsTiesLosses(WinsTiesLosses wtl, CardList knownCards, PokerHand myHand, CardList communityCards)
        {
            ...
            switch (myHand.Category)
            {
                case PokerHand.HandCategory.HighCard:

                    break;
                case PokerHand.HandCategory.Pair:
